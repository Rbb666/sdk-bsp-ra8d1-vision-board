...
#define OMV_JPEG_BUFFER_SIZE_MAX      (OMV_JPEG_BUF_SIZE - sizeof(jpegbuffer_t))

#if defined(__ARMCC_VERSION) && (__ARMCC_VERSION >= 6010050)
extern char Image$$OMV_MAIN_FB$$Base;        
extern char Image$$OMV_FB_END$$Base;
#define _fb_memory_start Image$$OMV_MAIN_FB$$Base
#define _fb_memory_end Image$$OMV_FB_END$$Base
#endif
